...
from .views import (
    ...
    toggle_parent_status, toggle_teacher_status, toggle_bursor_status, toggle_secretary_status, toggle_academic_status,
    toggle_all_parents_status, toggle_all_teachers_status, toggle_all_bursors_status, toggle_all_secretaries_status, toggle_all_academics_status
)
