# apps/disprine/migrations/0004_add_default_discipline_issue.py
...
def create_default_discipline_issue(apps, schema_editor):
    ...
    Action.objects.filter(discipline_issue__isnull=True).update(discipline_issue=default_issue)
